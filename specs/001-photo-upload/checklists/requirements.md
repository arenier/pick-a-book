...
- Aucun marqueur [NEEDS CLARIFICATION] : les zones d'incertitude (formats, taille, persistance de
  la photo, un envoi à la fois) avaient toutes une réponse déjà actée dans le code existant
  (`ScanController`, `ShelfPhoto`, `ShelfScannerPort`) ou dans l'ADR 0005, reprise en hypothèse
  plutôt qu'en question ouverte.
